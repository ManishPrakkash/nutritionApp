...
def create_docx():
    ...
    # Title
    title = doc.add_heading('Nutriapp - Technical Documentation', 0)
    ...
    doc.add_paragraph(
        'Nutriapp is a premium, high-performance mobile application built with Flutter, '
    ...
    run.bold = True
    p.add_run('https://nutriapp.onrender.com')
    ...
    # Footer
    doc.add_paragraph('\n---')
    doc.add_paragraph('Generated by Nutriapp Technical Support').alignment = WD_ALIGN_PARAGRAPH.RIGHT
